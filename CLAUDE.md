...
4개 테이블. RLS는 모두 `user_id = auth.uid()`.
...
│   ├── (learn)/               # learn/input·review·quiz·player + settings + todo(actions.ts 포함) (+ gamification-actions.ts, loading.tsx, error.tsx)
...
├── lib/{utils,origin,email,rate-limit,normalize-text,openai,gamification,tags,tag-color,tts-voices,settings-config,audio-loudness,audio-formats,audio-upload,feedback-sound,speech-recognition,sentence-number,sentence-filter,quiz-autoplay,stt-models,stt-client,todo}.ts
